...
RUN ${PREFIX_DIR}/bin/build-guacd.sh /app/guacamole-server-${GUACD_VER} "$PREFIX_DIR"
...
ADD https://github.com/ggxp2008/docker-guacamole/raw/master/guacamole-client-{JMS_VERSION}.tar.gz /tmp/
